...
const Footer = () => {
  ...
  return (
    <footer className="px-6 mt-6 bg-white">
      <div className="py-4">
        <div className="flex flex-col md:grid md:grid-cols-2">
          <div className="w-full -mx-6 text-left">
            <div className="px-6">
              <div>
                <a
                  href="#"
              ...
              <p className="w-full mt-2 text-gray-500 text-sm">
                We area a team of nurses, doctors, technologists and executives
